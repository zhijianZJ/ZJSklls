...
- `promotion`: minimum viable materials are the target responsibility/level, competency-gap material mapping current evidence to required scope, verified business impact/performance evidence, stakeholder-ready communication material, expanded-scope demonstration, negotiation prep for title/scope/compensation, and a specific advancement conversation plan.
